...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    pt: {
      ...
      case1_title: "Desacoplamento do Módulo de Faturamento (Order to Pay)",
      case1_metric: "-40% tempo de deploy",
      case1_desc: "Modularização do núcleo financeiro em monólito corporativo de grande porte, eliminando regressões críticas e permitindo releases independentes.",
      case2_badge: "ALTO TRÁFEGO & ESTABILIDADE",
      case2_title: "Estabilização e Tuning de Plataforma Educacional",
      case2_metric: "100% de estabilidade sob pico",
      case2_desc: "Otimização de consultas SQL críticas, arquitetura de cache multicamadas e eliminação de gargalos para suportar picos semestrais massivos.",
      case3_badge: "DADOS & BUSINESS INTELLIGENCE",
      case3_title: "Arquitetura de Dashboards Executivos de BI",
      case3_metric: "Tempo de resposta sub-segundo",
      case3_desc: "Consolidação de dados analíticos desacoplada da base transacional, oferecendo métricas operacionais em tempo real para tomadores de decisão.",
    ...
    en: {
      ...
      case1_title: "Order-to-Pay Billing Core Decoupling",
      case1_metric: "-40% deploy lead time",
      case1_desc: "Decoupled mission-critical billing logic from an enterprise monolith, eliminating production regression bugs and unlocking independent squad deploys.",
      case2_badge: "HIGH CONCURRENCY & UPTIME",
      case2_title: "Education Platform Stabilization & Tuning",
      case2_metric: "100% peak uptime",
      case2_desc: "Database indexing, query optimization, and multi-layer caching to effortlessly handle massive traffic surges during nationwide enrollment.",
      case3_badge: "DATA & BUSINESS INTELLIGENCE",
      case3_title: "Executive BI Data Dashboard Architecture",
      case3_metric: "Sub-second response time",
      case3_desc: "Engineered an analytical reporting architecture decoupled from the transactional database, empowering C-suite executives with instant operational data.",
